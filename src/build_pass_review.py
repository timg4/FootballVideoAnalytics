...
const DATA={data}, KEY={json.dumps(storage_key)};let state=JSON.parse(localStorage.getItem(KEY)||'{{}}');const root=document.querySelector('#root');
...
function save(){{localStorage.setItem(KEY,JSON.stringify(state));renderCount();}}
